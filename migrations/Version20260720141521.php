 ...
 */
final class Version20260720141521 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE input ADD CONSTRAINT `FK_D82832D75DA88751` FOREIGN KEY (tag_id_id) REFERENCES projects (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
